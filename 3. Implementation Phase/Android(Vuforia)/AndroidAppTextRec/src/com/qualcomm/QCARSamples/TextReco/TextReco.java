...
public class TextReco extends Activity {
    ...
    private final static int COLOR_OPAQUE = Color.argb(178, 0, 0, 127);
            ...
            public void run() {
                ...
                if (words.size() > 0) {
                    ...
                    for (String word : words) {
                        ...
                        // run query and update word results;
                       
                        if(word.contentEquals("TESTING"))
                        {
	                        word = "Number Plate:"+ searchWord+" \n";
	                        word += "Name: Phuluso \n";
	                        word += "Type: Private \n";
	                        word += "Stolen: No \n";
                        }
                        else if(word.contentEquals("DIGITS"))
                        {
	                        word = "Number Plate:"+ searchWord+" \n";
	                        word += "Name: Joas Mogale \n";
	                        word += "Type: Company \n";
	                        word += "Stolen: Yes \n";
                        }
                        else if(word.contentEquals("NUMBER"))
                        {
	                        word = "Number Plate:"+ searchWord+" \n";
	                        word += "Name: James Smith \n";
	                        word += "Type: Private \n";
	                        word += "Stolen: No \n";
                        }
                        else{
                        	
                        	 word= "Please Find Valid Target";
                        }
                        tv.setText(word);
                        LinearLayout.LayoutParams txtParams = new LinearLayout.LayoutParams(
                                LayoutParams.MATCH_PARENT,
                                LayoutParams.WRAP_CONTENT);
                        txtParams.setMargins(2, (count == 0) ? WORDLIST_MARGIN
                                : 0, 0,
