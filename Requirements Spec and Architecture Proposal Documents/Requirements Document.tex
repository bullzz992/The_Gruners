                ...
                \section{Functional requirements and application design}
                    ...
                    \subsection{Required functionality}
                    		\subsubsection{Number Plate Detection}
                    				...
                    				\begin{figure}[h]
					           				\centering
					           				\includegraphics[width=5.51in, height=3.77in]{Pictures/NumberPlateDetectionUseCase.jpg}
                   ...
                   % \subsection{Process specifications}
                    \subsection{Domain Objects}
                    		...
                    		\begin{figure}[h]
		                             \centering
		                             \includegraphics[width=4.59in, height=2.75in]{Pictures/CoreDomainObjects.jpg}
